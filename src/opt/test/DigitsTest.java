...
public class DigitsTest {
    ...
    private static int inputLayer = 7, hiddenLayer = 1, outputLayer = 1, trainingIterations = 1000, optIterations = 1000;
    ...
    public static void main(String[] args) {
        for(int i = 0; i < oa.length; i++) {
            ...
            System.out.println("init:" + nnop[i].toString());
        }
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/opt/test/abalone2.txt")));
